...
const AuctionReplyPreview = ({ auction, onViewAuction, onClose }) => (
  <View style={styles.container}>
    ...
    <Image source={utils.thumbnail(auction.images[0]?.image)} 
    style={styles.image} 
    />
    <View 
    style={styles.info}
    >
      <Text 
      style={styles.title}
      numberOfLines={1}>{auction.title}</Text>
...
const styles = StyleSheet.create({
  container: { flexDirection: "row", alignItems: "center", backgroundColor: "#f3f4f6", borderRadius: 8, margin: 8, padding: 8 },
  image: { width: 50, height: 50, borderRadius: 6, marginRight: 8 },
  info: { flex: 1 },
  title: { fontWeight: "bold", fontSize: 16 },
  button: { backgroundColor: "#22c55e", borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4, marginTop: 4, maxWidth:'25%' },
